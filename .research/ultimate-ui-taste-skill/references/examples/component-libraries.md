# Source Examples: Nexus UI, Astryx, Watermelon
...
Nexus UI teaches that AI interfaces need domain-specific slots, not one-off bubbles.
...
Astryx teaches primitive selection by product category: Action, Chat, Container, Content, Data Input, Feedback, Layout, Navigation, Overlay, Table/List, Utility.
...
Watermelon teaches component-library architecture: registry metadata, live rendered variants, code dialogs, categories, and responsive preview frames.
